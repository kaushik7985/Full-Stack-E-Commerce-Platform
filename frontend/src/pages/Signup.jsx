...
const Signup = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      setLoading(true)
      const res=await axios.post(`https://full-stack-e-commerce-platform-hy20.onrender.com/api/v1/user/register`,formData,{
        headers:{
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="grid gap-2">
              ...
              <div className="relative">
                ...
                />
                {
                    showPassword ? <EyeOff onClick={() => setShowPassword(false)} className="w-5 h-5
                     text-gray-700 absolute right-5 bottom-2"/>: 
                  <Eye onClick={() => setShowPassword(true)} className="w-5 h-5 text-gray-700
