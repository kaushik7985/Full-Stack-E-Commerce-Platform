...
if(sortOrder==='highToLow'){
  ...
  const handleSave = async (e) => {
    ...
    try {
      const res = await axios.put(
        `https://full-stack-e-commerce-platform-hy20.onrender.com/api/v1/product/update/${editProduct._id}`,
        formData,
        {
          headers: {
  ...
  const deleteProductHandler = async(productId) => {
    try {
      ...
      const res = await axios.delete(`https://full-stack-e-commerce-platform-hy20.onrender.com/api/v1/product/delete/${productId}`,{
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
        })
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-3">
                <Dialog open={open} onOpenChange={setOpen}>
                  ...
                  <DialogContent className="sm:max-w-[625px] bg-white max-h-[740px] overflow-y-scroll">
                    <DialogHeader>
                    ...
                    <DialogFooter>
                      ...
                      <Button
                        onClick={handleSave}
                        type="submit"
                        className="bg-black text-white hover:bg-gray-900">Save changes</Button>
                    </DialogFooter>
                  </DialogContent>
                </Dialog>
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent  className='bg-white'>
                    ...
                    <AlertDialogFooter>
                      ...
                      <AlertDialogAction onClick={()=>deleteProductHandler(product._id)} className="bg-black text-white hover:bg-gray-750">Continue</AlertDialogAction>
                    </AlertDialogFooter>
                  </AlertDialogContent>
                </AlertDialog>
