                             ...
                             return(
                                <Card key={idx} className='relative group overflow-hidden'>
                                    <CardContent>
                                        ...
                                        {/* remove button */}
                                        <button onClick={()=>removeImage(idx)} className='absolute top-1 right-1 bg-black/50 text-white p-1 rounded-full opacity-0 
                                        group-hover:opacity-100 transition'><X size={14}/></button>
                                    </CardContent>
                                </Card>
                             )
                        })
